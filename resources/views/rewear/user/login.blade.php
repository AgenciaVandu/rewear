...
<section id="user" class="mt-3">
    <div class="container espacio-login-card">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="row">
                    <div class="col-lg-5 col-md-12 col-sm-12 bg-login" style="background-image: url(/img/user/login.jpg);">
                    </div>
            ...
            <p class="gelion-thin text-center pt-3">
                ...
                <span class="gelion-bold"><a href="/user/register.html" style="color: #000; text-decoration: none;">Registrarme</a></span>
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container espacio-login-foto">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <img src="{{asset('/img/user/left.jpg')}}" alt="Modelos con playera ecológica" class="img-fluid">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <img src="{{asset('/img/user/right.jpg')}}" alt="Modelos con playera ecológica" class="img-fluid">
            </div>
        </div>
    </div>
</section>
