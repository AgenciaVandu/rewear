                    ...
                    <div class="card p-4">
                        <div class="d-none d-sm-none col-md-block d-lg-block">
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    ...
                                    <li class="gelion-thin"><a href="/catalogo/cart-empty.html" style="color: #000; text-decoration: none;">Vaciar cesta</a></li>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table mt-4 table-borderless">
                                ...
                                <tbody> 
                                  <tr class="text-center"> <!--producto-->
                                    <td>
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-6" id="cesta" >
                                                <img src="{{asset('/img/catalogo/producto/4.png')}}" class="fill-fit">
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-6 text-left m-auto pt-2">
                                                <p class="gelion-bold size-3">Camiseta cuello redondo <br>
                                                    <span>
                                                        <a href="" class="size-2 gelion-thin" style="text-decoration: none; color: #000;">Eliminar</a>
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <p class="gelion-thin pt-3">Mujer</p>
                                    </td>
                                    <td>
                                        <p><div id="productos-cajas" class="m-auto gelion-thin">
                                    ...
                                    <td>
                                        <p class="gelion-thin pt-3">Roja</p>
                                    </td>
                                    <td>
                                        <p class="gelion-thin pt-3">L</p>
                                    </td>
                                  </tr>
                                  <tr class="text-center"> <!--producto-->
                                    <td>
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-6" id="cesta">
                                                <img src="{{asset('/img/carrito/1.png')}}" class="fill-fit">
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-6 text-left m-auto pt-2">
                                                <p class="gelion-bold size-3">Camiseta cuello redondo <br>
                                                    <span>
