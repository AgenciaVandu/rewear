<div class="container py-8">
    <x-table-responsive>
        <div class="px-6 py-4 bg-white">
            <h1 class="text-lg font-semibold uppercase mb-6 text-trueGray-700">Carro de compras</h1>
        </div>
        @if (Cart::count())
        ...
        @else
            <div class="flex flex-col items-center">
                ...
                <x-button-link href="/" class="mt-4 px-16" color="trueGray">
                    Ir al inicio
                </x-button-link>
            </div>
        @endif
    ...
    @if (Cart::count())
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mt-4">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <x-button-link color="trueGray" href="{{ route('orders.create') }}">
                        Continuar
                    </x-button-link>
                </div>
            </div>
