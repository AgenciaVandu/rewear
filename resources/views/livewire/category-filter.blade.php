<div>
    <div class="bg-white rounded-lg shadow-lg mb-6">
        <div class="flex justify-between items-center px-6 py-2">
            ...
            <div class="grid grid-cols-2 border border-trueGray-200 divid-x divide-trueGray-200 text-trueGray-500">
            ...
            <ul class="divide-y divide-trueGray-300">
                @foreach ($category->subcategories as $subcategory)
                    <li class="py-2 text-sm cursor-pointer">
                        <a class="hover:text-trueGray-500 capitalize {{ $subcategoria == $subcategory->name ? 'text-trueGray-800 font-bold' : '' }}"
                            ...
                            <article class="flex">
                                ...
                                <div class="flex-1 py-4 px-6 flex flex-col">
                                    <div class="flex justify-between">
                                        <div>
                                            <h1 class="text-lg font-semibold text-trueGray-700">{{ $product->name }}
                                            </h1>
